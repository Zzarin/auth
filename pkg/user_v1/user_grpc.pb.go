...
func (c *userV1Client) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.UserV1/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/user.UserV1/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/user.UserV1/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userV1Client) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/user.UserV1/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
